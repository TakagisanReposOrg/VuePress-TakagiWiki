...
async function build(ssgOptions = {}, viteConfig = {}) {
  ...
  const ssgOut = path.join(root, ".vite-ssg-temp", Math.random().toString(36).substring(2, 12));
  ...
  const _require = module$1.createRequire((typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (document.currentScript && document.currentScript.src || new URL('shared/vite-ssg.fffacce4.cjs', document.baseURI).href)));
