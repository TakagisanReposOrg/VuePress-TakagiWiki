import { Page, PluginFunction, PageFrontmatter } from '@vuepress/core';
...
type ModifyTimeGetter = <ExtraPageData extends Record<string | number | symbol, unknown> & {
    ...
    git?: GitData;
}, ExtraPageFrontmatter extends Record<string | number | symbol, unknown> = Record<never, never>, ExtraPageFields extends Record<string | number | symbol, unknown> = Record<never, never>>(page: Page<ExtraPageData, ExtraPageFrontmatter, ExtraPageFields>) => string;
