...
.file-selector[data-v-cbb0a4e5]::-webkit-scrollbar {
  height: 1px;
}
.file-selector[data-v-cbb0a4e5]::-webkit-scrollbar-track {
  background-color: var(--border);
}
.file-selector[data-v-cbb0a4e5]::-webkit-scrollbar-thumb {
  background-color: var(--color-branding);
}
.file-selector.has-import-map .add[data-v-cbb0a4e5] {
  margin-right: 10px;
}
...
.file.active[data-v-cbb0a4e5] {
  color: var(--color-branding);
  border-bottom: 3px solid var(--color-branding);
  cursor: text;
}
.file span[data-v-cbb0a4e5] {
  display: inline-block;
  padding: 8px 10px 6px;
  line-height: 20px;
}
.file.pending input[data-v-cbb0a4e5] {
  width: 90px;
  height: 30px;
  line-height: 30px;
  outline: none;
...
.add[data-v-cbb0a4e5]:hover {
  color: var(--color-branding);
}
.icon[data-v-cbb0a4e5] {
  margin-top: -1px;
}
.import-map-wrapper[data-v-cbb0a4e5] {
  position: sticky;
  margin-left: auto;
  top: 0;
  right: 0;
...
.dark .import-map-wrapper[data-v-cbb0a4e5] {
  background: linear-gradient(
    90deg,
    rgba(26, 26, 26, 0) 0%,
    rgba(26, 26, 26, 1) 25%
...
.iframe-container[data-v-6c05459a],
.iframe-container[data-v-6c05459a] iframe {
  width: 100%;
  height: 100%;
  border: none;
