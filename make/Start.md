...
请将站点托管的Github仓库 [点击跳转](https://github.com/TakagiWikiSitesCN/VuePress-TakagiWiki) fork（复刻）至你的Github账号下，在复课后的个人仓库内自主编辑。编辑完成后点击“关于”栏左侧的contribute（贡献）按钮，点击open pull request（提交拉取请求），编辑好本次提交的简介，可在右侧选择受理人和本次编辑内容的类型。提交完成后，源仓库这边会收到拉取请求，您只要等待这边确认合并分支。您提交的分支内容将于源仓库主分支合并并自动触发网站重部署，这样一次内容编辑就完成了。
